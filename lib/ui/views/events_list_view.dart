...
class EventsListView extends StatefulWidget {
  ...
  @override
  _EventsListViewState createState() => _EventsListViewState(); //Utilisation de _EventsListViewState pour gérer l’état de l’écran
}
        ...
        builder: (context, model, child) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return EventCard(
                event: event,
              ); // Widget pour afficher un événement
            },
          );
        },
      ),
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.pushNamed(
            context,
            "/create_event",
          ); //Quand l’utilisateur clique sur le FloatingActionButton, il est redirigé vers la page de création d’événement
        },
